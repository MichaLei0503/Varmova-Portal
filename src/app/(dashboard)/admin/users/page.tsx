...
export default async function AdminUsersPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Benutzerverwaltung" description="Rollen, Aktivstatus und zugehörige Firmenprofile zentral verwalten." />
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-700">
                  {user.salesPartner?.companyName || user.installer?.companyName || "Interner Varmova Benutzer"}
                </p>
              </div>
            </div>
            ...
            <form action={updateUserAccessAction} className="grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:grid-cols-[1fr_auto_auto] md:items-end">
              ...
              <div>
                ...
                <Select name="role" defaultValue={user.role}>
                  ...
                  <option value="SALES">Vertriebspartner</option>
