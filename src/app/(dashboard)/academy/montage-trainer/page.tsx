...
import { MONTAGE_TRAINER_PATH } from "@/lib/tools";

export const metadata = { title: "Montage-Trainer · Varmi Academy" };

export default function MontageTrainerPage() {
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-3xl border border-slate-200 bg-night shadow-soft">
        <iframe
          src={MONTAGE_TRAINER_PATH}
          title="Varmi Montage-Trainer — die Montage in 12 animierten Schritten"
